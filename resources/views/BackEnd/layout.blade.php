...
<body class="animsition">
    ...
    <script src="{{asset('backend/js/main.js')}}"></script>
      ...
      <script src="{{asset('backend/vendor/fullcalendar-3.10.0/lib/moment.min.js')}}"></script>
      <script src="{{asset('backend/vendor/fullcalendar-3.10.0/fullcalendar.js')}}"></script>
    ...
    <script src="{{asset('backend/vendor/vector-map/jquery.vmap.brazil.js')}}"></script>
    <script src="{{asset('backend/vendor/vector-map/jquery.vmap.europe.js')}}"></script>
    <script src="{{asset('backend/vendor/vector-map/jquery.vmap.france.js')}}"></script>
    <script src="{{asset('backend/vendor/vector-map/jquery.vmap.germany.js')}}"></script>
    <script src="{{asset('backend/vendor/vector-map/jquery.vmap.russia.js')}}"></script>
    <script src="{{asset('backend/vendor/vector-map/jquery.vmap.usa.js')}}"></script>
