...
<!-- hero area -->
<section class="hero-section hero" data-background="" style="background-image: url({{ asset('frontend/images/hero-area/banner-bg.png')}});">
  <div class="container">
    <div class="row">
      <div class="col-lg-12 text-center zindex-1">
        ...
        <!-- banner image -->
        <img class="img-fluid w-100 banner-image" src="{{ asset('frontend/images/hero-area/banner-img.png')}}" alt="banner-img">
      </div>
    </div>
  </div>
  <!-- background shapes -->
...
<section class="section feature mb-0" id="feature">
  ...
  <img class="feature-bg-1 up-down-animation" src="{{ asset('frontend/images/background-shape/feature-bg-1.png')}}" alt="bg-shape">
  <img class="feature-bg-2 left-right-animation" src="{{ asset('frontend/images/background-shape/feature-bg-2.png')}}" alt="bg-shape">
</section>
<!-- /feature -->
...
<section class="section-lg seo">
  <div class="container">
    <div class="row">
      <div class="col-md-6">
        <div class="seo-image">
          <img class="img-fluid" src="{{ asset('frontend/images/marketing/marketing.png')}}" alt="form-img">
        </div>
      </div>
      <div class="col-md-5">
  ...
  <div class="container">
    <div class="row justify-content-between">
      ...
      <div class="col-md-7 order-1 order-md-2">
        <img class="img-fluid layer-3" src="{{ asset('frontend/images/service/service.png')}}" alt="service">
      </div>
    </div>
  </div>
  <!-- background image -->
